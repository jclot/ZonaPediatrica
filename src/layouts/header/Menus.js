...
export const Experience = () => <Link legacyBehavior href="/doctor-details">MÍ EXPERIENCIA</Link>;
export const Schedule = () => <Link legacyBehavior href="/time-table">HORARIOS</Link>;
export const Contact = () => <Link legacyBehavior href="/contact">CONTACTO</Link>;
